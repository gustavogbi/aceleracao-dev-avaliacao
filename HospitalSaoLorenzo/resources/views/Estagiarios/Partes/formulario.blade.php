...
<div class="form-group row">
    <div class="col-md">
        ...
        <input type="text" class="form-control form-control-user"
            value="{{ $estagiario->grauDeEscolaridade ?? old('grauDeEscolaridade') }}" name="grauDeEscolaridade"
    ...
    <div class="form-group row">
        <div class="col-md">
            ...
            <input type="number" class="form-control form-control-user"
                value="{{ $estagiario->telefone ?? old('telefone') }}" name="telefone"
                placeholder="DDD + Telefone Ex: (XX) XXXX-XXXX">
        </div>
        <div class="col-md">
            e-mail:
