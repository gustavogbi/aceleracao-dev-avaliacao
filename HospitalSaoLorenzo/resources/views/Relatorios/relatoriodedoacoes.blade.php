...
@section('content')
    ...
    <div class="row">
        ...
        <div class="d-sm-flex align-items-center ">
            <a href="/doador">
                <h1 class="h3 mb-3 text-warning aling-center">Doadores</h1>
            </a>
        </div>
        <div class="col-md-12">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-white">{{ $qtd_doadores }} Cadastros
                                    </div>
                                </div>
                                <div class="col">
        ...
        <div class="d-sm-flex align-items-center ">
            <a href="/bancodesangue">
                <h1 class="h3 mb-3 text-danger aling-center">Banco de Sangue</h1>
            </a>
        </div>
        <div class="col-md-12">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-white">{{ $qtd_bancodesangues }}
                                        Cadastros</div>
                                </div>
                                <div class="col">
                                    <div class="progress progress-sm mr-2">
                                        <div class="progress-bar bg-primary" role="progressbar"
                                            style="width:{{ $qtd_bancodesangues * 100 }}px" aria-valuenow="50"
        ...
        <div class="d-sm-flex align-items-center ">
            <a href="/doacoes">
                <h1 class="h3 mb-3 text-dark aling-center">Doações</h1>
            </a>
        </div>
        <div class="col-md-12">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-white">{{ $qtd_doacoes }} Cadastro(s)
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="progress progress-sm mr-2">
                ...
                <div class="card-body ">
                    ...
                    @foreach ($doacoes as $doacao)
                        ...
                        <p class="text-dark"> Feito doação de {{ $doacao->qtd_litros }} litros por
                            ...
                            email {{ $doacao->email }} na data de
                            {{ \Carbon\Carbon::parse($doacao->created_at)->format('d/m/Y') }} </p>
