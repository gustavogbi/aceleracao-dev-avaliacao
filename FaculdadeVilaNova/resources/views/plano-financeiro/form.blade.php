...
<div class="form-group row">
  ...
  <div class="col-md-10">
      <input id="nome" type="text" class="form-control" name="nome" value="{{ $cad->nome ?? "" }}">
  </div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-md-10">
      <input id="desconto" type="number" min="0" max="100" class="form-control" name="desconto" value="{{ $cad->desconto ?? "" }}">
  </div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-md-10">
      <input id="observacao" type="text" class="form-control" name="observacao" value="{{ $cad->observacao ?? "" }}">
  </div>
</div>
