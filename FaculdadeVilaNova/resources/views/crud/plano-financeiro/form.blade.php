...
<div class="form-group row">
  ...
  <div class="col-md-10">
      <input id="desconto" type="number" min="0" max="100" class="form-control" name="desconto" value="{{ $cad->desconto ?? old('desconto') }}">
  </div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-md-10">
      <input id="observacao" type="text" class="form-control" name="observacao" value="{{ $cad->observacao ?? old('observacao') }}">
  </div>
</div>
